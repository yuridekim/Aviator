...
//+kubebuilder:rbac:groups=vm.cloudclub.io,resources=updates,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=vm.cloudclub.io,resources=updates/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=vm.cloudclub.io,resources=updates/finalizers,verbs=update
